...
namespace SORT {
    ...
    constexpr void bubbleSort(RandomIt begin, RandomIt end, Comparator compere) {
        bool change = true;
    ...
    constexpr void bubbleSort(Container &container, int start, int size, Comparator compere) {
        int temp;
        bool change = true;
